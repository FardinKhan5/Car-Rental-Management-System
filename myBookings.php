    ...
    <nav class="navbar navbar-expand-lg bg-dark sticky-top" data-bs-theme="dark">
        <div class="container-fluid">
          ...
          ?>
                ...
                <form class="d-flex" role="search" method="get" action="myBookings.php">
...
<div class="container-fluid p-0 m-0"
        ...
        <div class="row row-cols-1 m-0 py-5" style="background-color: rgba(0, 0, 0, 0.573);">
            ...
            <div class="col text-center"><h2 class="h2 text-light fw-bold">My Bookings</h2></div>
    ...
    <div class="container-fluid my-3">
        <div class="row row-cols-lg-3 py-3">
            ...
            include 'includes/bookingDetails.php';
