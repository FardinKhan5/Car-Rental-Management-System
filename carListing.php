        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="carListing.php">Car Listing</a>
                    </li>
                    <li class="nav-item">
          ...
          ?>
                ...
                <form class="d-flex" role="search" method="get" action="carListing.php">
                    <input class="form-control me-2" type="search" placeholder="Search" id="searchCar" name="searchCar"
                        aria-label="Search">
  ...
  ?>
    <div class="container-fluid p-0 m-0"
        ...
        if(isset($_GET['searchCar'])) {
            echo '<div class="col text-center"><h2 class="h2 text-light fw-bold">Search Results for "'.$_GET["searchCar"].'"</h2></div>
            <div class="col d-flex justify-content-center">';
        }else{
            echo '<div class="col text-center"><h2 class="h2 text-light fw-bold">Car Listing</h2></div>
            <div class="col d-flex justify-content-center">';
        }
        ?>
    ...
    <div class="container-fluid my-3">
        <div class="row row-cols-lg-3 py-3">
            <?php
        if(isset( $_GET['searchCar'])){
            include 'includes/searchCar.php';
        }else{
            include 'includes/carsList.php';
        }
